...
exports.render = function(id,data) {	
	...
	source = handleSonTemplate(source);
  data.include = function(filepath) {
    var str = fs.readFileSync(__dirname+filepath)+'';
    console.log(str);
  };
  //return;
	var funcCode = "";
...
function handleSonTemplate(str) {
  var reg = /<%\s*(\w+\.html)\s*%>/g;
  str = str.replace(reg, '<%=include("$1")%>');
  return str;
}
